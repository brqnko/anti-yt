...
func (mock *YouTubeClientMock) SearchIDs(ctx context.Context, query string, pageToken string, opts youtube_d.SearchOptions) ([]youtube_d.SearchItem, string, error) {
	if mock.SearchIDsFunc == nil {
		panic("YouTubeClientMock.SearchIDsFunc: method is nil but Client.SearchIDs was just called")
	}
	callInfo := struct {
		Ctx       context.Context
		Query     string
...
func (mock *YouTubeClientMock) SearchIDsCalls() []struct {
	Ctx       context.Context
	Query     string
	PageToken string
	Opts      youtube_d.SearchOptions
