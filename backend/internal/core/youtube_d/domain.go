...
var (
	...
	ErrChannelAutoGenerated        = core.NewDomainError("youtube.channel_auto_generated", "auto-generated topic channels are not supported", core.StatusBadRequest)
)
...
func NewChannel(id, displayName, customID, description, iconURL string, subscribersCount uint64, uploadsPlaylistID string, createdAt time.Time) (_ Channel, err error) {
	...
	if strings.HasSuffix(displayName, "- Topic") {
		return Channel{}, ErrChannelAutoGenerated
	}
