  ...
  return (
    <DashboardLayout>
      <div class="p-6">
        ...
        {!isAuthenticated && !isAuthLoading && (
          <div class="relative overflow-hidden grid md:grid-cols-[1.1fr_1fr] items-center gap-8 md:gap-14 px-8 md:px-10 py-10 md:py-14 rounded-xl mb-8 bg-background-light border border-border-light">
            <div class="flex flex-col gap-5 md:pl-8 lg:pl-12">
              ...
              <div class="flex flex-col gap-2 items-start">
                <button
                  ...
                  class="flex items-center justify-center gap-3 rounded-xl bg-white px-6 py-3 text-sm font-bold text-slate-700 border border-slate-200 hover:bg-slate-50 hover:border-primary/50 cursor-pointer"
                >
                  <GoogleIcon />
                  {t("common.signInWithGoogle")}
                </button>
                <p class="text-xs text-text-muted-light leading-relaxed">
                  {t("common.oidcNoticeNoPii")}
                </p>
              </div>
              <a href="/about" class="text-sm font-bold text-charcoal hover:text-primary no-underline">
