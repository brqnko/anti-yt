        ...
        <form class="space-y-10" onSubmit={handleSubmit}>
          ...
          <div class="pt-6 flex items-center justify-end gap-4">
            <button
              ...
              class="w-full sm:w-auto px-8 py-3.5 bg-primary hover:bg-[#b8a37e] text-charcoal font-bold rounded-xl shadow-lg shadow-primary/20 transition-all flex items-center justify-center gap-2 group cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
